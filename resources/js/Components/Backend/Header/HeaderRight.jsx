...
function HeaderRight({avatar}) {
    const {rightHeader} = useSelector(state => state.menuItems)
        ...
        <div className="header-right">
            <ul className="clearfix">
                ...
                <li className="icons dropdown d-none d-md-flex languageBtn">
                    <Link href="#" className="log-user" data-toggle="dropdown" onClick={e => dropDownMenuAction(e, 'languageBtn')}>
